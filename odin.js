//added an event listener and function name
...
function validate() {
  ...
  //added a thin solid red border(like an error class) 
  if (password.value === "") {
  ...
  //added a thin solid red border and some text "Passwords do not match" 
